...
Project Setup
I began by creating a new project directory named aws-free-tier-terraform. Inside this directory, I created the following Terraform files:
...
my_ip = "00.000.000.00/32" key_name = "projects-key-pair" 
